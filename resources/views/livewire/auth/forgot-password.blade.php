                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            ...
                            @endif
                            <h4 class="mb-0">{{ __('Lupa Password? Masukan Emailmu disini') }}</h4>
                        </div>
                        <div class="card-body">
                            ...
                            @if ($showSuccesNotification)
                                <div wire:model="showSuccesNotification"
                                    ...
                                    <span
                                        class="alert-text text-white">{{ __(' Email untuk reset Password sudahd dikirim!') }}</span>
                            ...
                            @if ($showFailureNotification)
                                <div wire:model="showFailureNotification"
                                    ...
                                    <span class="alert-text text-white">
                                        {{ __('Kamu belum mendaftar sebagai Anggota. Mohon Lakukan Regristrasi!') }}
