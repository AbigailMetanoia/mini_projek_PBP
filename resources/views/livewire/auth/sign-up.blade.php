              ...
              <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                  <div class="card z-index-0">
                      ...
                      <div class="card-body">
                          ...
                          <form wire:submit.prevent="register" action="#" method="POST" role="form text-left" enctype="multipart/form-data">
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                <div class="@error('no_telp') border border-danger rounded-3  @enderror">
                                    <input wire:model="no_telp" type="text" class="form-control" placeholder="Nomor Telepon"
                                        aria-label="no_telp" aria-describedby="email-addon">
                                </div>
                                @error('no_telp') <div class="text-danger">{{ $message }}</div> @enderror
                              </div>
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <input wire:model="file_ktp" class="form-control" type="file" id="file_ktp" name="file_ktp" placeholder="Upload Foto KTP">
                              </div>
