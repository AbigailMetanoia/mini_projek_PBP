                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <div class="search-bar">
                                ...
                                {{-- <input type="search" wire:model='search' placeholder="Search..." id="search-input">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    {{-- <td class="ps-4" style="text-align: center;">
                                        <p class="text-xs font-weight-bold mb-0">{{ ($view_books ->currentpage()-1) *
                                            $view_books ->perpage() + $loop->index + 1 }}</p>
                                    </td> --}}
                                    {{-- <td style="text-align: center;">{{ ($view_books ->currentpage()-1) *
                                        $view_books ->perpage() + $loop->index + 1 }}</td> --}}
